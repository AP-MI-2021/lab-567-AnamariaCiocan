...
def test_create():
    cheltuieli=get_data()
    params = (13, 12, 1500, '27.08.2020', 'intretinere',[], [])
...
def get_data():
    return [
        creeaza_cheltuiala(1, 23, 2100, '24.05.2020', 'intretinere'),
        creeaza_cheltuiala(2, 11, 1900, '28.07.2021', 'canal'),
        creeaza_cheltuiala(3, 22, 2300, '28.09.2021', 'intretinere'),
        creeaza_cheltuiala(4, 20, 1300, '21.10.2021', 'alte cheltuieli')
    ]
...
def test_update():
    cheltuieli = get_data()
    c_updated = creeaza_cheltuiala(1, 11, 2400, '31.09.2020', 'alte cheltuieli')
