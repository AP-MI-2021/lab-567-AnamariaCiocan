...
def create(lst_cheltuieli, id_apartament:int, numar_apartament, suma, data, tip_intretinere, tip_canal, tip_alte_cheltuieli):
    '''
    :return: o lista noua si formata din cea precedenta si noua cheltuiala
    '''
    cheltuiala = creeaza_cheltuiala(id_apartament, numar_apartament, suma, data, tip_intretinere, tip_canal, tip_alte_cheltuieli)
    return lst_cheltuieli + [cheltuiala]

def read(lst_cheltuieli, id_apartament=None):
    '''
...
def delete(lst_cheltuieli, id_apartament:int):
    '''
